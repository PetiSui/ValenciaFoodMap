  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col w-full px-[9dvw] max-sm:px-6 mx-auto mt-8 mb-8">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,_minmax(230px,_1fr))] max-md:grid-cols-[repeat(auto-fit,_minmax(180px,_1fr))] max-sm:grid-cols-[repeat(auto-fit,_minmax(130px,_1fr))] gap-5 mt-6 max-sm:mt-4">
